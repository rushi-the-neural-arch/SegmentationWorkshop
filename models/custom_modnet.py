...
class Conv2dIBNormRelu(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, 
                 ...
                 with_ibn=True, with_relu=True, dropout_prob=0.001):         #############################  DROPOUT Probability mentioned here, 0.001 seems a proper value as we have a small network, BUT don't make it 0.1!! ###############
